...
const Select: FunctionComponent = () => {
  ...
  const onColdBackgroundClick = useCallback(() => {
    navigate("/selct-3");
  }, [navigate]);
  ...
  return (
    <div className="w-full relative bg-aliceblue overflow-y-auto flex flex-row items-start justify-start pt-[54px] px-0 pb-2 box-border gap-0.5 leading-[normal] tracking-[normal] text-left text-17xl text-black font-poppins lg:flex-wrap">
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[11px] max-w-full">
          <div className="self-stretch h-[537px] relative max-w-full mq750:h-auto mq750:min-h-[537]">
            <FrameComponent13
              propTop="232px"
              propHeight="305px"
              teenyiconsdownOutline="pending_I43:1169;9:202"
            />
                              ...
                              <div className="self-stretch flex flex-row items-start justify-start py-0 pl-[11px] pr-0">
                                <div className="h-11 flex-1 relative">
                                  <div
                                    ...
                                    onClick={onColdBackgroundClick}
                                  />
                                  <div className="absolute top-[13px] left-[46px] tracking-[-0.02em] leading-[23px] font-light inline-block w-8 h-[23px] min-w-[32px] z-[5]">
                                    Cold
                                  </div>
                                </div>
                              </div>
          ...
          <TripAction
            rectangle320="pending_I43:1218;9:426"
      ...
      <FrameComponent2
        ...
        tripsSeparator="pending_43:1231"
      />
    </div>
  );
};
